// src/main/java/com/service/document/service/impl/DocumentServiceImpl.java
...
public class DocumentServiceImpl implements DocumentService {
    ...
    public DocumentResponseDTO create(
        ...
        String fileUrl = storageClient.upload(file, file.getOriginalFilename());

        // 2. Resolve category and department
        ...
        kafkaTemplate.send("document-events", new DocumentCreatedEvent(saved.getId(), ownerId));
    ...
    public void delete(
        ...
        kafkaTemplate.send("document-events", new DocumentCreatedEvent(id, userId));
    }
    ...
    public Page<DocumentResponseDTO> search(
        ...
        Page<Document> page = documentRepository.searchByKeyword(keyword, collectionIds, pageable);
